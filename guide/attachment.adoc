Peppol BIS Billing 3.0 there is no possibility to provide a presentation (PDF-image) of the invoice or credit note. To support presentation in Pagero UF it's possible to set the below
