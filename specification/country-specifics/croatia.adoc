...
Croatia supports self-billing where the buyer issues the invoice on behalf of the seller. Self-billing uses the Croatian process type P12.

To indicate self-billing in PUF, use the `puf:SelfBilled` extension set to `true` combined with the standard type code and the process type `P12` in the `@name` attribute.

*Example Self-billing Invoice*
[source,xml]
----
<Invoice>
    <ext:UBLExtensions>
    ...
    <cbc:InvoiceTypeCode name="P12">380</cbc:InvoiceTypeCode>
    <!-- Code omitted for clarity -->
</Invoice>
----

*Example Self-billing Credit Note*
[source,xml]
----
<CreditNote>
    <ext:UBLExtensions>
    ...
    <cbc:CreditNoteTypeCode name="P12">381</cbc:CreditNoteTypeCode>
    <!-- Code omitted for clarity -->
</CreditNote>
----

Ensure the `ext:UBLExtensions` block is placed as the first element in the document.
