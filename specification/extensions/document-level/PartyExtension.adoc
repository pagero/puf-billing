The UBL extension to be used for below elements can be found in <<_party, cac:Party>>.
...
|`puf:RoleCode`
|**Party role code** +
To specify the role of the party in the context of the invoice. +
The `puf:RoleCode` must be coded using the https://pagero.github.io/puf-code-lists/#_puf_021_rolecode[PUF-021-ROLECODE^] code list.
