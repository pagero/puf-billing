...
Minor releases may include bugfixes, new elements, schematron updates and other features. These releases can be followed on https://github.com/pagero/puf-billing[GitHub^].

==== Major release

A major release may include changes that are not backward compatible. Such a release will be notified at least three months prior to date of implementation, to users who registered an account on Pagero validex or on https://github.com/pagero/puf-billing[GitHub^].

To register for PUF major release notification you can create an account on https://pagero.validex.net[https://pagero.validex.net^]. But we urge all interested parties to follow the project on https://github.com/pagero/puf-billing[GitHub^] where all releases will be notified.
